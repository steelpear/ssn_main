...
export const ActionFormSection = () => {
  return (
    <main className='px-4 md:px-5 lg:px-8 z-0'>
      <div className='relative w-full bg-left-bottom bg-cover bg-no-repeat px-3 md:px-5 py-4 md:py-6 my-4 border-round-2xl shadow-4 action-form-bg'>
        <div className='grid grid-nogutter w-full flex justify-content-center'>
          ...
          <div className="col-12 md:col-7 h-full">
            <div className='w-full'>
              <div className={`${Prosto.className} text-2xl font-medium text-white mt-3 md:mt-0 mb-4 pl-3 md:pl-6`} style={{textShadow: '0px 0px 3px grey'}}>Оставьте сообщение и мы вам перезвоним</div>
              <div className='flex align-items-end justify-content-center md:justify-content-end mr-0 lg:mr-7'>
                <div>
                  ...
                  <div className='relative flex align-items-center gap-3 mt-2'>
                    <p className={`${Pacifico.className} hidden md:block text-xl line-height-1 text-white`}>Или просто<br/>позвоните</p>

...
export const PopularDirections = () => {
  ...
  return (
    <main>
      <div className='text-2xl text-700 font-medium ml-5 my-1 cursor-pointer text-blue-600 hover:underline inline-block' onClick={() => router.push('/popular-directions')}>Популярные направления</div>
